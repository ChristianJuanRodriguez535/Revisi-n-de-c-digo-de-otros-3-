...
//usamos cont en lugar de var 
//creamos elemento li en lugar de div para hacer la lista
...
function productosPantalla (arregloProductos) {
  ...
  for (let i = 0; i < productos.length; i++) {
   ...
   const titulo = document.createElement("p");
    ...
    //Afregar titulo e imagen al elemento 
...
function filtrarProductos (texto){
   ...
   const textoMinusculas = texto.toLowerCase(); //para que no haya problea con minusculas 
